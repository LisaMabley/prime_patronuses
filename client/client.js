...
app.controller('MainController', ['$http', function($http) {
  ...
  controller.getPeople = function() {
    ...
    .then(function(response) {
      ...
      controller.personLast = '';
      controller.personFirst = '';
    });
  }

  controller.addPatronus = function(){
    $http.post('/patronus', {name: controller.patName})
    .then(controller.getPats);
  }

  controller.addPerson = function(){
    $http.post('/people', {first_name: controller.personFirst, last_name: controller.personLast})
    .then(controller.getPeople);
  }
